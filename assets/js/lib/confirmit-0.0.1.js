var confirmit = function(obj, callback) {
	...
	var $cfmBtnAllow = $('<li class="cfm-btn allow-btn">' + allow + '</li>');
	var $cfmBtnBullet = $('<li class="cfm-btn bullet">&bull;</li>');
	var $cfmBtnDisallow = $('<li class="cfm-btn disallow-btn">' + disallow + '</li>');
