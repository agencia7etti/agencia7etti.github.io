var promptit = function(obj, callback) {
	...
	var $pptBtnAllow = $('<li class="ppt-btn allow-btn">' + allow + '</li>');
	var $pptBtnBullet = $('<li class="ppt-btn bullet">&bull;</li>');
	var $pptBtnDisallow = $('<li class="ppt-btn disallow-btn">' + disallow + '</li>');
